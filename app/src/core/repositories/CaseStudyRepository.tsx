import type { ICaseStudyRepository } from "../repositories";
...
export class CaseStudyRepository implements ICaseStudyRepository {
  ...
  getApkUrl(): string {
    return "https://drive.google.com/file/d/1AIKitbd8IKUUQ9kqYOtPaoyRT2bZ3wGJ/view?usp=drive_link";
  }

  getGithubUrl(): string {
    return "https://github.com/jed-bot-1";
  }
}